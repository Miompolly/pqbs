    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Career</h6>
                <h1 class="mb-5">Build Your Future with Professional Quality Building Service</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    
                    <p class="mb-4">
                    Join our team of over 5,000 skilled experts and work on innovative projects across Qatar, Africa, and beyond. Explore our current openings in construction, design, development, facility management, fit-out, and manufacturing, and find the perfect role for you.</p>
                ...
                <h5>Why Work with Us?</h5>               
                    ...
                    <p class="mb-4"> Opportunities to work on innovative and impactful projects</p>
                    <p class="mb-4"> Grow your career with continuous learning and development.</p>
                    <p class="mb-4"> A collaborative and inclusive work environment.</p>
                    <p class="mb-4"> Opportunities for creativity and professional autonomy.</p>
